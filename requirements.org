...
*** Requirements
    ...
    - [0.5] Theme header tags with CSS // h1-h6?
    - [0.5] Theme images and images captions with CSS // how to set captions
...
*** Requirements
    ...
    - [ ] Take 2 screenshots of firefox running all of your pages that
      demonstrates your theme.
    - [0.5] Ensure that files are appropriately named and CASE SENSITIVE.
    ...
    - [0.5] screenshots good.png, bad.png, gutenberg1.png, gutenberg2.png, gutenberg3.png should be in the root of the project.
